...
PM_START_TEXT = """
👋 Hey There, My Name is *Mordex*.[Mordex](https://telegra.ph/file/b7a30e1f882059830bca0.jpg) 
...
buttons = [
    [
        InlineKeyboardButton(
            text="Natsuki News 🙋‍♂️", url="https://t.me/Mordex_Updates"
        ),
        InlineKeyboardButton(
            text="Support Group 💬", url="https://t.me/MordexSupport_Official"
        ),
    ],
    [
        InlineKeyboardButton(
            text="Source 🗒", url="Github.com/Venuja104"
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            ...
            url="t.me/TheMorDexBot?startgroup=true",
        ),
    ],
]

NATSUKI_IMG = "https://telegra.ph/file/b7a30e1f882059830bca0.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/b7a30e1f882059830bca0.jpg)
...
def Natsuki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Mordex Updates.* "
            f"\n\n Join [MordexUpdates](https://t.me/Mordex_Updates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Mordex Support](https://t.me/MordexSupport_Official).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [VndBotSupport](https://t.me/VndBotSupport)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by Venuja Sadew"
